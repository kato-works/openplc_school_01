...
char plc_program_md5[] = "3160eb10244f513a45aca1e664378a99";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.CR), BOOL_ENUM},
    {&(RES0__INSTANCE0.CR4), BOOL_ENUM},
    {&(RES0__INSTANCE0.CR5), BOOL_ENUM},
    {&(RES0__INSTANCE0.CR6), BOOL_ENUM},
    {&(RES0__INSTANCE0.CR7), BOOL_ENUM},
    {&(RES0__INSTANCE0.SW1), BOOL_P_ENUM},
    {&(RES0__INSTANCE0.SW2), BOOL_P_ENUM},
    {&(RES0__INSTANCE0.CR1), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.CR2), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.CR3), BOOL_O_ENUM},
};
